...
public class FizzBuzz {
   ...
   * <code>value</code>, depending on whether <code>value</code> is divisible by 3 or 5.
   *
  ...
  /**
   * Checks if number is divisible by 3 and returns true or false.
   *
  ...
  /**
   * Checks if number is divisible by 5 and returns true or false.
   *
   * @param value Integer value to be tested.
   * @return true or false
   */
